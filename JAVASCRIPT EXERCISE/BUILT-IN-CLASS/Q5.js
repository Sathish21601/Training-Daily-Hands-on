...
const allFrontend = datas.filter(function (data) {
  return data.category === "frontend";
});
console.log(allFrontend);

const cityBang = datas.filter(function (data) {
  return data.location.city === "Bangalore";
});
console.log(cityBang);

const firstOnline = datas.find(function (data) {
  return data.modes.online === true;
});
console.log(firstOnline);

const lastOnline = datas.reverse().find(function (data) {
  return data.modes.online === true;
});
console.log(lastOnline);

const firstOnlineAndInperson = datas.reverse().find(function (data) {
  return (data.modes.online === true) & (data.modes.inPerson === true);
});

console.log(firstOnlineAndInperson);

const noOfOnline = datas.filter(function (data) {
  return data.modes.online === true;
});
console.log(noOfOnline.length);

const imageURLS = datas.map(function (data) {
  return data.imageUrl;
});
console.log(imageURLS);

const structure = datas.map(function (data) {
  return `{ name: ${data.name} , id :${data.id} }`;
});
console.log(structure);

const allFrontendStr = datas
