    ...
    <div className="pt-20 grid grid-cols-3 gap-10 p-[2%]">
      {products.map((product, idx) => {
        return (
          ...
          >
            <img
              className="w-[50%] h-[50%] ml-[25%]"
              src={product.image}
              alt=""
            />
            <div className="px-6 py-4">
              <div className="font-light-200 font-sherif text-xl mb-2 overflow-hidden truncate w-300 capitalaize">
                {product.title}
              </div>
            </div>
            <div className="flex justify-between px-6 pt-4 pb-2">
              ...
              {/* <span className="inline-block bg-blue-500 text-white rounded-full px-3 py-3 text-sm font-semibold mr-2 mb-2 ">Add To Cart</span> */}
              <span>
                <svg
